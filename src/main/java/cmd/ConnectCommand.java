...
public class ConnectCommand implements ICommand {
    ...
    public void execute(Environment env, String arg, NetPackage netPackage) {
        ...
        try {
            communication = new CommunicationUDP(env.getClientPort(),env.getServerPort(),env.getServerAddress());
            ...
            while (true) {
                ...
                ICommand a = new ICommand() {
                    ...
                    public void execute(Environment env, String arg, NetPackage netPackage) {
                        ...
                        if (cmd.isHasObject())
                            netPackage.setCity(new RequestElement(env.getIn(), env.getOut(), true).readElement(netPackage.getUser()));
                    }
                };
